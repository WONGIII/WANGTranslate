...
- **Local OCR** — Offline text recognition powered by tesseract.js, 9 languages supported
- **Selection Translate** — Select text anywhere, press a hotkey, get instant translation
- **Screenshot OCR** — Drag to select an area on screen, extract text, translate it
- **Silent OCR** — Screenshot text recognition straight to clipboard, no popup
- **Input Translate** — Type or paste text for translation
- **Multi-API Comparison** — Enable multiple API endpoints and compare translations side by side
- **System Tray** — Runs quietly in the system tray, always ready
- **Global Hotkeys** — Fully customizable keyboard shortcuts (default: unbound)
- **History & Favorites** — Auto-saved translation and OCR history with search
- **Text-to-Speech** — Read original or translated text aloud (via system TTS engine)
- **Chinese/English UI** — Full bilingual interface, switch anytime
...
2. Click the tray icon or press a hotkey to open **Settings**
